  ...
  <div class="col-lg-12">
    <div class="ibox">
      <div class="ibox-content text-right clearfix">
        ...
        <div class="col-md-6">
          <form role="form" class="form-inline" name="search" id="search" action="{{ url('/facturas/buscador') }}" method="post">
            {{ csrf_field() }}
            <div class="form-group">
              <label for="" class="sr-only">Mes</label>
              <select name="month" id="month" aria-controls="editable" class="form-control">
                <option value="0">[Seleccione]</option>
                <option value="01" @if($month == '01') selected @endif>Enero</option>
                <option value="02" @if($month == '02') selected @endif>Febrero</option>
                <option value="03" @if($month == '03') selected @endif>Marzo</option>
                <option value="04" @if($month == '04') selected @endif>Abril</option>
                <option value="05" @if($month == '05') selected @endif>Mayo</option>
                <option value="06" @if($month == '06') selected @endif>Junio</option>
                <option value="07" @if($month == '07') selected @endif>Julio</option>
                <option value="08" @if($month == '08') selected @endif>Agosto</option>
                <option value="09" @if($month == '09') selected @endif>Septiembre</option>
            ...
            <div class="form-group">
              <label for="" class="sr-only">A&ntilde;o</label>
              <select name="year" id="year" aria-controls="editable" class="form-control">
                <option value="0">[Seleccione]</option>
