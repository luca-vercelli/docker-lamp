...
if($note->id > 10 && $note->id < 100) {
	$noteNumeration = '000';
}

if($note->id > 100 && $note->id < 1000) {
	$noteNumeration = '00';
}

if($note->id > 1000 && $note->id < 10000) {
	$noteNumeration = '0';
}


if($noteNumeration != '') {
	$noteId = $noteNumeration.$noteId;
}
?>
<!DOCTYPE html>
<html lang="en"><head>
<meta charset="utf-8">
<title>Nota de Cr&eacute;dito #{{ $noteId }}</title>
...
<div id="wrapper">
  ...
  <div id="main">
    ...
    <div id="meta-data">
        <div id="factura-meta">
       	  <div id="factura" >
						Nota de Cr&eacute;dito No.: {{ $billId }}</div>
    ...
    <div id="item-wrapper">
    	<table border="0" cellspacing="0" cellpadding="0" class="table">
          ...
          <tr>
            ...
            <td style="height:450px; overflow:hidden" valign="top">{!! $note->description !!}</td>
            <td>&nbsp;</td>
    ...
    <div id="footer">
    	<p>
			ESTA NOTA DE CR&Eacute;DITO VA SIN TACHADURA NI ENMENDADURA
		</p>
		</div>
  </div>
</div>
