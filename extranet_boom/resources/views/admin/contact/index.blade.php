    ...
    <div class="ibox">
      <div class="ibox-content text-right clearfix">
        <div class="col-md-8 text-left">
            <h2 class="items-counter">{{ sizeof($contacts) }} contactos encontrados</h2>
        </div>
        <div class="col-md-4">
          <a href="#" class="btn btn-outline btn-success btn-rounded">Exportar</a>
          <a class="btn btn-outline btn-primary btn-rounded" href="{{ url('/admin/contactos/nuevo') }}">
         ...
         <div class="ibox-content">
            ...
            <table class="footable table table-stripped" data-page-size="50" data-filter=#filter>
               ...
               <tbody>
                 ...
                 <tr class="">
                    <td><a href="{{ url('admin/contactos/actualizar') }}/{{ $contact->id }}">{{ $contact->name }}</a></td>
