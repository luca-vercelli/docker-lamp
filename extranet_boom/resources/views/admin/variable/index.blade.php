    ...
    <div class="ibox">
      <div class="ibox-content text-right clearfix">
        <div class="col-md-8 text-left">
          <h2 class="items-counter">{{ sizeof($variables) }} variables encontradas</h2>
        </div>
        <div class="col-md-4">
          <a class="btn btn-outline btn-primary btn-rounded" href="{{ url('/admin/variables/nuevo') }}">
      ...
      <div class="ibox-content">
        ...
        <table class="footable table table-stripped" data-page-size="50" data-filter=#filter>
          ...
          <tbody>
            ...
            <tr class="">
              <td><a href="{{ url('admin/variables/actualizar') }}/{{ $variable->id }}">{{ $variable->name }}</a></td>
