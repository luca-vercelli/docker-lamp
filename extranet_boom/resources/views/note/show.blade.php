...
<form class="" action="{{ url('/notas/nuevo') }}/{{ $bill->id }}" method="post">
{!! csrf_field() !!}
    ...
    <div class="col-lg-12">
        <div class="ibox">
            <div class="ibox-content text-right">
                <a href="{{ url('/notas') }}" class="btn btn-outline btn-white btn-rounded">Cancelar</a>
                <a href="{{ url('/notas/imprimir') }}/{{ $note->id }}" class="btn btn-outline btn-primary btn-rounded form-submit" target="_blank">
                  <i class="glyphicon glyphicon-print" aria-hidden="true"></i> Imprimir
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="ibox-content">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label>Nota</label>
                            <textarea name="description" id="description" class="form-control" disabled>{{ $note->description }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="quantity" id="quantity" value="1" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="exemption" id="exemption" value="<?php echo $bill->exemption; ?>" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <div class="radio">
                            <label>
                              <input type="radio" name="IVA" id="IVA{{ $count }}" value="{{ $variable->value }}" @if($bill->base_IVA == $variable->value) checked @endif disabled>
                              {{ $variable->value }}%
                            </label>
                          </div>
                          @endforeach
